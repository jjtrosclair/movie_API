...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios
      .get(`https://my-flix-app-4455.herokuapp.com/users/${username}`, {
  ...
  deleteFavoriteMovie(movieId) {
    ...
    axios
      .delete(
        `https://my-flix-app-4455.herokuapp.com/${localStorage.getItem(
          "user"
      ...
      .catch((e) => {
        alert("could not remove movie" + e);
      });
  }
  ...
  deleteUser(e) {
    axios
      .delete(
        `https://my-flix-app-4455.herokuapp.com/users/${localStorage.getItem(
          "user"
        )}`,
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
